import SectionAzul from '../utils/SectionAzul'
import Contato from './Contato'
import { FaWhatsapp, FaPhoneVolume } from "react-icons/fa";
import SectionBranca from '../utils/SectionBranca';
...
import DescricaoDasSections from '../utils/DescricaoDasSections'
    ...
    return(
        <>
            <SectionBranca>
                <div className="block sm:grid grid-cols-2 gap-10">
                    <div className="max-w-[500px] flex flex-col justify-center mt-4 sm:mt-0">
                        ...
                        <DescricaoDasSections 
                            descricao="ERP financeiro simples, seguro e de fácil implantação. Automatize suas rotinas financeiras e tenha suas informações organizadas. Mais controle, tempo e previsibilidade para tomar as melhores decisões."
                        />
            ...
            <SectionAzul>
                ...
                <div className="block sm:grid grid-cols-2 gap-10">
                    ...
                    <div className="max-w-[500px] flex flex-col justify-center mt-7 sm:mt-0">
                        ...
                        <DescricaoDasSections 
                            descricao={`
                                Um ERP para gestão financeira com um poderoso ecossistema que transforma a relação das empresas com seus contadores e bancos.
                                \n \n
            ...
            <SectionAzul>
                ...
                <DescricaoDasSections 
                    descricao="Atuamos em muitos segmentos. Deixa a Conta Azul te ajudar! Qual o seu perfil de negócio?" 
                />
                <SwiperSegmentos />
            </SectionAzul>
            ...
            <SectionBranca>
                <div className="text-center">
                    ...
                    <DescricaoDasSections 
                        descricao="Veja o que estão falando da gente nas redes."
                    />
            ...
            <SectionAzul>
                <div className="block sm:grid grid-cols-2 gap-10">
                    ...
                    <img className="rounded-lg self-center" src="https://ca.contaazul.com/wp-content/uploads/2024/01/mapa2.png" />
                </div>
            </SectionAzul>
            ...
            <SectionBranca>
                <div className="block sm:grid grid-cols-2 gap-10">
                    ...
                    <img className="rounded-lg self-center" src="https://ca.contaazul.com/wp-content/uploads/2024/01/plano-negocio-947x1024-1.png" />
                </div>
            </SectionBranca>

            <SectionAzul>
                <div className="block sm:grid grid-cols-2 gap-10 pb-[85px]">
                    <img className="rounded-lg self-center" src="https://ca.contaazul.com/wp-content/uploads/2023/04/MG_9170-1.png"  />
                    <div className="max-w-[500px] flex flex-col justify-center mt-8 sm:mt-0">
                        ...
                        <DescricaoDasSections 
                            descricao="Fale com nosso time de especialistas e tire todas as suas dúvidas"
                        />
